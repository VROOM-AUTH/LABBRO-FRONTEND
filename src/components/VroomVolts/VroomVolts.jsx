      ...
      <div className="current-level">
        <div className="level-box">
          ...
          <div className="progress-bar-container">
            <ProgressBar
              bgcolor={"#feb800"}
              completed={(totalUserVolts / levelMax) * 100}
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="ways-to-win">
                <p>
                  1) Check in at the lab every day for 5 days and win 50
                  VroomVolts.
                </p>
                <p>2) For every GitLab commit win 1 VroomVolt.</p>
                <p>
                  3) Check in at the lab every day for 5 days and win 50
                  VroomVolts.
                </p>
                <p>
                  4) Check in at the lab every day for 5 days and win 50
                  VroomVolts.
                </p>
              </div>
            </div>

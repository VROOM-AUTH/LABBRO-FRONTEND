            ...
            <div className="roulette-content-container">
                ...
                <div className="roulette-bet-board">
                    <div className="roulette-bet-row">
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 6)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(6)}
                        >
                            6
                            {bets.some((bet) => bet.numbers[0] === 6)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 9)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(9)}
                        >
                            9
                            {bets.some((bet) => bet.numbers[0] === 9)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 12)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(12)}
                        >
                            12
                            {bets.some((bet) => bet.numbers[0] === 12)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 15)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(15)}
                        >
                            15
                            {bets.some((bet) => bet.numbers[0] === 15)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 18)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(18)}
                        >
                            18
                            {bets.some((bet) => bet.numbers[0] === 18)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 21)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(21)}
                        >
                            21
                            {bets.some((bet) => bet.numbers[0] === 21)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 24)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(24)}
                        >
                            24
                            {bets.some((bet) => bet.numbers[0] === 24)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 27)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(27)}
                        >
                            27
                            {bets.some((bet) => bet.numbers[0] === 27)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 30)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(30)}
                        >
                            30
                            {bets.some((bet) => bet.numbers[0] === 30)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 33)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(33)}
                        >
                            33
                            {bets.some((bet) => bet.numbers[0] === 33)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 36)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(36)}
                        >
                            36
                            {bets.some((bet) => bet.numbers[0] === 36)
                                ?.amount !== 0 && (
                    ...
                    <div className="roulette-bet-row">
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 8)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(8)}
                        >
                            8
                            {bets.some((bet) => bet.numbers[0] === 8)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 11)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(11)}
                        >
                            11
                            {bets.some((bet) => bet.numbers[0] === 11)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 14)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(14)}
                        >
                            14
                            {bets.some((bet) => bet.numbers[0] === 14)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 17)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(17)}
                        >
                            17
                            {bets.some((bet) => bet.numbers[0] === 17)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 20)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(20)}
                        >
                            20
                            {bets.some((bet) => bet.numbers[0] === 20)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 23)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(23)}
                        >
                            23
                            {bets.some((bet) => bet.numbers[0] === 23)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 26)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(26)}
                        >
                            26
                            {bets.some((bet) => bet.numbers[0] === 26)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 29)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(29)}
                        >
                            29
                            {bets.some((bet) => bet.numbers[0] === 29)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 32)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(32)}
                        >
                            32
                            {bets.some((bet) => bet.numbers[0] === 32)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 35)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(35)}
                        >
                            35
                            {bets.some((bet) => bet.numbers[0] === 35)
                                ?.amount !== 0 && (
                    ...
                    <div className="roulette-bet-row">
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 7)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(7)}
                        >
                            7
                            {bets.some((bet) => bet.numbers[0] === 7)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 10)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 16)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(16)}
                        >
                            16
                            {bets.some((bet) => bet.numbers[0] === 16)
                                ?.amount !== 0 && (
                        ...
                        <div
                            ...
                            onClick={() => handleBetClick(19)}
                        >
                            19{" "}
                            {bets.some(
                                (bet) =>
                                    bet.numbers[0] === 19 &&
                                    bet.type !== "nineteento36"
                            )?.amount !== 0 && (
                                <p className="bet-amount">
                                    {
                                        bets.find(
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 22)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(22)}
                        >
                            22
                            {bets.some((bet) => bet.numbers[0] === 22)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 28)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(28)}
                        >
                            28
                            {bets.some((bet) => bet.numbers[0] === 28)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 31)
                                    ? "bet-number bet-active"
                                    : "bet-number"
                            }
                            onClick={() => handleBetClick(31)}
                        >
                            31
                            {bets.some((bet) => bet.numbers[0] === 31)
                                ?.amount !== 0 && (
                        ...
                        <div
                            className={
                                bets.some((bet) => bet.numbers[0] === 34)
                                    ? "bet-number-r bet-active"
                                    : "bet-number-r"
                            }
                            onClick={() => handleBetClick(34)}
                        >
                            34
                            {bets.some((bet) => bet.numbers[0] === 34)
                                ?.amount !== 0 && (
                    ...
                    <div className="roulette-bet-row">
                        ...
                        >
                            Even
                            {bets.some((bet) => bet.type === "even")?.amount !==
                                0 && (
                                <p className="bet-amount">
                                    {
                                        bets.find((bet) => bet.type === "even")
                                            ?.amount
                                    }
                                </p>
                            )}
                        ...
                        >
                            Red
                            {bets.some((bet) => bet.type === "red")?.amount !==
                                0 && (
                                <p className="bet-amount">
                                    {
                                        bets.find((bet) => bet.type === "red")
                                            ?.amount
                                    }
                                </p>
                            )}
                        ...
                        >
                            Odd
                            {bets.some((bet) => bet.type === "odd")?.amount !==
                                0 && (
                                <p className="bet-amount">
                                    {
                                        bets.find((bet) => bet.type === "odd")
                                            ?.amount
                                    }
                                </p>
                            )}

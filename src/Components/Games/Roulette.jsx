...
export default function Roulette({ userVroomVolts, setUserVroomVolts, userData }) {
    const fetchVroomvolts = () => {
        return fetch(`${process.env.REACT_APP_BASE_URL}users-levels?user_id=${userData.userId}`, {
                ...
                <div className='roulette-bet-board'>
                    <div className='roulette-bet-row'>
                        ...
                        <div className={bets.some((bet) => bet.numbers[0] === 12) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(12)}>
                            12
                            {bets.some((bet) => bet.numbers[0] === 12)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 12)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 15) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(15)}>
                            15
                            {bets.some((bet) => bet.numbers[0] === 15)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 15)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 18) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(18)}>
                            18
                            {bets.some((bet) => bet.numbers[0] === 18)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 18)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 21) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(21)}>
                            21
                            {bets.some((bet) => bet.numbers[0] === 21)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 21)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 24) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(24)}>
                            24
                            {bets.some((bet) => bet.numbers[0] === 24)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 24)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 27) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(27)}>
                            27
                            {bets.some((bet) => bet.numbers[0] === 27)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 27)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 30) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(30)}>
                            30
                            {bets.some((bet) => bet.numbers[0] === 30)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 30)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 33) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(33)}>
                            33
                            {bets.some((bet) => bet.numbers[0] === 33)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 33)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 36) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(36)}>
                            36
                            {bets.some((bet) => bet.numbers[0] === 36)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 36)?.amount}</p>}
                        </div>
                    </div>
                    <div className='roulette-bet-row'>
                        ...
                        <div className={bets.some((bet) => bet.numbers[0] === 11) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(11)}>
                            11
                            {bets.some((bet) => bet.numbers[0] === 11)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 11)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 14) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(14)}>
                            14
                            {bets.some((bet) => bet.numbers[0] === 14)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 14)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 17) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(17)}>
                            17
                            {bets.some((bet) => bet.numbers[0] === 17)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 17)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 20) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(20)}>
                            20
                            {bets.some((bet) => bet.numbers[0] === 20)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 20)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 23) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(23)}>
                            23
                            {bets.some((bet) => bet.numbers[0] === 23)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 23)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 26) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(26)}>
                            26
                            {bets.some((bet) => bet.numbers[0] === 26)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 26)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 29) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(29)}>
                            29
                            {bets.some((bet) => bet.numbers[0] === 29)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 29)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 32) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(32)}>
                            32
                            {bets.some((bet) => bet.numbers[0] === 32)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 32)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 35) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(35)}>
                            35
                            {bets.some((bet) => bet.numbers[0] === 35)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 35)?.amount}</p>}
                        </div>
                    </div>
                    <div className='roulette-bet-row'>
                        ...
                        <div className={bets.some((bet) => bet.numbers[0] === 10) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(10)}>
                            10
                            {bets.some((bet) => bet.numbers[0] === 10)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 10)?.amount}</p>}
                        </div>
                        ...
                        <div className={bets.some((bet) => bet.numbers[0] === 16) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(16)}>
                            16
                            {bets.some((bet) => bet.numbers[0] === 16)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 16)?.amount}</p>}
                        </div>
                        ...
                        <div className={bets.some((bet) => bet.numbers[0] === 22) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(22)}>
                            22
                            {bets.some((bet) => bet.numbers[0] === 22)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 22)?.amount}</p>}
                        </div>
                        ...
                        <div className={bets.some((bet) => bet.numbers[0] === 28) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(28)}>
                            28
                            {bets.some((bet) => bet.numbers[0] === 28)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 28)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 31) ? "bet-number bet-active" : "bet-number"} onClick={() => handleBetClick(31)}>
                            31
                            {bets.some((bet) => bet.numbers[0] === 31)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 31)?.amount}</p>}
                        </div>
                        <div className={bets.some((bet) => bet.numbers[0] === 34) ? "bet-number-r bet-active" : "bet-number-r"} onClick={() => handleBetClick(34)}>
                            34
                            {bets.some((bet) => bet.numbers[0] === 34)?.amount !== 0 && <p className='bet-amount'>{bets.find((bet) => bet.numbers[0] === 34)?.amount}</p>}
                        </div>
                    </div>
                    <div className='roulette-bet-row'>

...
const SpinningWheel = ({ userVroomVolts, setUserVroomVolts }) => {
    ...
    const spin = () => {
        ...
        if (prizes[randomIndex] === "1") {
            ...
            setTimeout(() => {
                ...
                setUserVroomVolts((prev) => (prev - 500 > 0 ? prev - 500 : 0));
            }, 5000);
            ...
            setTimeout(() => {
                setSpinning(false);
                setUserVroomVolts((prev) => (prev - 25 > 0 ? prev - 25 : 0));
            }, 5000);
    ...
    return (
        <div className='spinning-wheel-container'>
            <div className='spinning-wheel-content-container'>
                ...
                <div className='wheel-instructions'>Each spin costs 5 Vroomvolts!</div>
                ...
                <div className='wheel-button-container'>
                    {userVroomVolts >= 5 ? (
                        <button disabled={spinning} onClick={spin} className='wheel-spin-button' id='spin-button'>
                            GO
                        </button>
                    ) : (
                        <div className='wheel-not-enough'>You don't have enough Vroomvolts for a spin.</div>
                    )}
                </div>
            </div>
        </div>
